...
public class CardDAO {
	...
	public static HashMap<Integer, Card> cardMap;
	...
	private void initializeCards()
	{
		...
		try 
		{
			...
			while(scan.hasNextLine())
			{
				...
				Card card = new Card(Integer.valueOf(cardArray[0]), cardArray[1], Integer.valueOf(cardArray[2]), cardArray[3], RarityType.valueOf(cardArray[4]), CardType.valueOf(cardArray[5]));
